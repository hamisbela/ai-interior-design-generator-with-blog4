    ...
    >
      {(isExpanded || !compact) && (
        <input
          ...
          className={`${inputClassName} border border-gray-300 px-4 py-2 rounded-l-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 flex-grow text-sm`}
          aria-label="Search"
        />
      )}
      <button
